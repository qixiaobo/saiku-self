...
*/
		var data = JSON.stringify(exModel)

		for (var param in exModel.parameters) {
			data = data.replace(new RegExp("\\$\\{" + param + "}", "gm"), exModel.parameters[param])
		}


		this.result.save({}, {
			contentType: "application/json", data: data, error: function () {
            Saiku.ui.unblock();
